...
- **024** - Remove custom sku selector from PDP and use native one.
- **024** - Add 'meter' as valid measurement unit to exhibit `product-selling-price#pdp-square-meter` block.

### Fixed

- **024** - [PDP] Resolved issue with duplicate product name block that hid selected SKU

## [3.3.0] - 2025-03-10

### Added

- **35** - Add `insider-confirmation-tag` custom block on the order-placed page.
...
- **029** - Add conditional block to exhibit unit measurement on shelves.

## [3.1.0] - 2025-02-18

### Added

- **008** - Add custom banner component on the PDP page.

## [3.0.16] - 2025-01-30

### Fixed

- **004** - [PDP] Fixed broken description due to display flex
